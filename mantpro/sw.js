const CACHE='mantpro-cloud-v12';
const ASSETS=['./','./index.html','./instalar.html','./styles.css?v=12','./manual-fields.css?v=12','./config.js?v=12','./auth.js?v=12','./jspdf.umd.min.js?v=12','./app.js?v=12','./manifest.webmanifest'];
