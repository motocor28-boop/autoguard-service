const CACHE='levantamiento-repuestos-ia-v3-1-1';
const CORE=['./','index.html','styles.css','config.js','auth.js','app.js','install.js','manifest.webmanifest','icon-192.png','icon-512.png'];
