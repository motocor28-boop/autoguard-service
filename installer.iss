...
OutputDir=output
OutputBaseFilename=SuperScan 2.0 Profesional Setup R3
...
begin
  WizardForm.WelcomeLabel2.Caption :=
    'Este asistente instalará SuperScan 2.0 Profesional con diagnóstico OBD-II, base offline de 12.133 códigos y planes de acción, solución guiada, gráficos HD, Freeze Frame e informes PDF profesionales.';
end;
